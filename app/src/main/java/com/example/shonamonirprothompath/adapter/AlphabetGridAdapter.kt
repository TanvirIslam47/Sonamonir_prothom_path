...
class AlphabetGridAdapter(context: Context, objects: ArrayList<AlphabetGridModel>) :
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        if (listitemView == null) {
            listitemView =
                LayoutInflater.from(context).inflate(R.layout.alphabet_grid_view, parent, false)
        }
